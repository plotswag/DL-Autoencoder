...
def train(model, loader, criterion, optimizer, epochs=5):
    ...
    print("Register Number:2122243002")
...
![image](https://github.com/user-attachments/assets/be03eded-25b9-4dab-8608-6e03f24d489a)

### Training loss:

![image](https://github.com/user-attachments/assets/4de1b0d9-cb19-4978-8539-747a59a4a3e5)

### Original vs Noisy Vs Reconstructed Image:

![image](https://github.com/user-attachments/assets/836126f0-181c-4aff-8920-b0c9b053fa8e)
